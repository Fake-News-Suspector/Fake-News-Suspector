...
def main():
    ...
    flag=0
    url='https://www.yahoo.com/news/gop-lawmaker-knocks-trump-putin-call-refuses-distance-president-135204872.html'
    for i in category:
    ...
    #     #if(re.search(url, i[1], re.IGNORECASE)):
    #         if(j[0].lower() in list1 or j[1].lower() in list1):
    #             print("Location:",j[1])
    #             flag=1
    #             break
